...
async function checkSchema() {
  ...
  `;
    ...
    try {
        console.log("Fetching schema for libaray_Chapter...");
        const data = await graphqlRequest(query, {});

        if (data && data.__type) {
            console.log("Schema found for libaray_Chapter:");
            ...
            console.log("Type 'libaray_Chapter' not found or no data returned.");
